...
func (c *goStoreClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteReply, error) {
	out := new(WriteReply)
	err := c.cc.Invoke(ctx, "/GoStore/Write", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goStoreClient) Update(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteReply, error) {
	out := new(WriteReply)
	err := c.cc.Invoke(ctx, "/GoStore/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goStoreClient) Delete(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*WriteReply, error) {
	out := new(WriteReply)
	err := c.cc.Invoke(ctx, "/GoStore/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
