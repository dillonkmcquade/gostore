...
func TestLevel0Compaction(t *testing.T) {
	...
	opts.MemTableOpts.Max_size = 50
	opts.ManifestOpts.Level0_max_size = 100
	opts.SSTable_max_size = 50
	...
	for i := 0; i < 51; i++ {
		tree.Write(int64(i), []byte(""))
	}
